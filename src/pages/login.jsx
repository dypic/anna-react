  ...
  return (
    <div className="login container-maxWidth">
      <div className="login-form">
        <svg className="login-form__logo" width="72" height="48" viewBox="0 0 72 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="24" cy="24" r="24" />
          <path fillRule="evenodd" clipRule="evenodd" d="M72 0C58.7452 -1.15877e-06 48 10.7452 48 24C48 37.2548 58.7452 48 72 48L72 0Z" />
        </svg>
        <div className="login-form__input">
          <input type="text" placeholder="아이디" className="body3" />
          <input type="password" placeholder="패스워드" className="body3" />
          <button type="button" className="btn-l pry-btn1">
            <a href="#">로그인</a>
          </button>
        </div>
      </div>
